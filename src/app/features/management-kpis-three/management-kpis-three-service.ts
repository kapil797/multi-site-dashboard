...
import { ManagementLayerOneData } from '@mk3/management-kpis-three-model';
import { ManagementKpisThreeModule } from '@mk3/management-kpis-three.module';
@Injectable({
  providedIn: ManagementKpisThreeModule,
})
export class ManagementKpisThreeService {
  constructor(
