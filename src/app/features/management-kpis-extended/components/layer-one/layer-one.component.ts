...
import { ManagementLayerOneData } from '@mkext/management-kpis-extended-model';
import { ManagementKpisExtendedService } from '@mkext/management-kpis-extended-service';
...
export class LayerOneComponent extends LayerOneRouter implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private mk: ManagementKpisExtendedService,
