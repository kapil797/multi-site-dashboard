...
import { ManagementKpisExtendedModule } from '@mkext/management-kpis-extended.module';
import { ManagementLayerOneData } from '@mk/management-kpis-model';
@Injectable({
  providedIn: ManagementKpisExtendedModule,
})
export class ManagementKpisExtendedService {
  constructor(
