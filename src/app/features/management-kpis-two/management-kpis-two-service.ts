...
import { ManagementLayerOneData } from '@mk2/management-kpis-two-model';
import { ManagementKpisTwoModule } from '@mk2/management-kpis-two.module';
@Injectable({
  providedIn: ManagementKpisTwoModule,
})
export class ManagementKpisTwoService {
  constructor(
