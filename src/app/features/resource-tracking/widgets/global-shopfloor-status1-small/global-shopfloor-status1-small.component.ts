...
@Component({
  selector: 'app-global-shopfloor-status1-small',
  templateUrl: './global-shopfloor-status1-small.component.html',
  styleUrl: './global-shopfloor-status1-small.component.scss',
})
export class GlobalShopfloorStatus1SmallComponent {
  theme?: Theme;
