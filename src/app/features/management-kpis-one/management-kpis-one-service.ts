...
import { ManagementKpisOneModule } from '@mk1/management-kpis-one.module';
import { ManagementLayerOneData } from '@mk1/management-kpis-one-model';
@Injectable({
  providedIn: ManagementKpisOneModule,
})
export class ManagementKpisOneService {
  constructor(
